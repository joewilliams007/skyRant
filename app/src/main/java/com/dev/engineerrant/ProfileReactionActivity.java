...
public class ProfileReactionActivity extends AppCompatActivity {

    public static List<Reactions> profile_reactions;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Tools.setTheme(this);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_profile_reaction);
        createList();
    }
    ...
    public void createList(){
        ...
        try {
            for (Reactions item : profile_reactions){
    ...
    private void build(ArrayList<ReactionItem> menuItems) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(ProfileReactionActivity.this);
        ...
        mAdapter = new ReactionAdapter(this, menuItems, new ReactionAdapter.AdapterCallback() {
            ...
            public void onItemClicked(Integer menuPosition, String open) {
                ...
                Intent intent = new Intent(ProfileReactionActivity.this, RantActivity.class);
                intent.putExtra("id",String.valueOf(menuItem.getPost_id()));
